// Generated from lib/referral-dates.ts by scripts/build-referral-extension.mjs.
/**
...
function getZurichParts(instant) {
 ...
 */
function zurichOffsetMsAt(instantMs) {
 ...
 */
export function zonedZurichTimeToUtc(parts) {
    const localAsUtcMs = Date.UTC(parts.year, parts.month - 1, parts.day, parts.hour, parts.minute, parts.second, parts.millisecond);
 ...
 */
export function getReferralTrialEndsAt(startsAt) {
...
export function getZurichPartsForTests(instant) {
